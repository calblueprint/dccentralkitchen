import { daysOfTheWeek, daysOfTheWeekAbbrev, daysOfTheWeekFull, today } from '../constants/DaysOfTheWeek';
...
export function computeStoreOpen(hours) {
  ...
  try {
    ...
    if (
      ...
      return 'Open now until '.concat(closingTime).replace('12am', 'Midnight');
    }
