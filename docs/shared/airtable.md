...
We use Airtable as the backing database for all of our applications. To start off, we recommend reading through [this section of the admin guide](../admin.md#airtable) which covers Airtable basics, how to interact via the UI, and an overview of our `PROD` base.
